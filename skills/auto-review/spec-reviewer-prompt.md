...
Use when dispatching a spec compliance reviewer. **Purpose:** verify the implementer built what was requested (nothing more, nothing less) AND that the plan itself matched the user's original intent.
